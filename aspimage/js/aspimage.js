var ImageDialog = {
	preInit : function() {
		...
		//if (url = tinyMCEPopup.getParam("external_image_list_url"))
			//document.write('<script language="javascript" type="text/javascript" src="/keypoint/database/tinymce/jscripts/tiny_mce/plugins/lists/image_list.js"></script>');
	...
	insertAndClose : function(file) {
		...
		//, f = document.forms[0], nl = f.elements, v, args = {}, el;
